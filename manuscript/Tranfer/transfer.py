...
EXPERIMENTS = {
    ...
    "InceptionNet": {
        "Cifar10": {
    "Original Model": None,
    "Stage 5": ("stage5.inception_5a", "stage5.inception_5b"),
    "Stage 4": ("stage4.inception_4a", "stage4.inception_4b"),
    "Stage 3": ("stage3.inception_3a", "stage3.inception_3b"),
    "Stage 2": ("stem.conv1", "stem.pool2"),
    "Stage 3-5": ("stage3.inception_3a", "stage5.inception_5b"),
    ...
    "Original Model": None,
    "Stage 5": ("block5", "pool"),
    "Stage 4": ("block4", "block5"),
    "Stage 3": ("block3", "block4"),
    "Stage 2": ("block2", "block3"),
    "Stage 1": ("block1", "block2"),
    "Stage 3-5": ("block3", "block5"),
    "Stage 2-5": ("block2", "block5"),
    "Stage 1-5": ("block1", "block5"),
    "Last 2": ("block4", "block5"),
},
        "Cifar100": {
    "Original Model": None,
    "Stage 5": ("block5", "pool"),
    ...
    "Original Model": None,
    "Stage 7": ("block7", "pool"),
    "Stage 6": ("block6", "block7"),
    "Stage 5": ("block5", "block6"),
    "Stage 4": ("block4", "block5"),
    "Stage 3": ("block3", "block4"),
    "Stage 2": ("block2", "block3"),
    "Stage 1": ("block1", "block2"),
    "Stage 5-7": ("block5", "block7"),
    "Stage 4-7": ("block4", "block7"),
    "Stage 1-7": ("block1", "block7"),
    "Last 2": ("block6", "block7"),
},
        "Cifar100": {
    "Original Model": None,
    "Stage 7": ("block7", "pool"),
